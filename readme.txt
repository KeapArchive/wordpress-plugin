...
= If you are an Infusionsoft and WordPress user =
If your plugin says that you'll have Infusionsoft functionality enabled after installing this plugin, please do so, and then set your Infusionsoft API credentials in the plugin settings. You're done!
...
1. Set your Infusionsoft API credentials in the plugin settings
